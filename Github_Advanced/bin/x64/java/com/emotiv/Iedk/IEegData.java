...
public interface IEegData extends Library {
	...
	*/
	...
	/*
	 * ! \return 
	 *             - EDK_ERROR_CODE - EDK_ERROR_CODE = EDK_OK if the command succeeded
	 */
	int IEE_EdfStart();
	 ...
	 *              - EDK_ERROR_CODE - EDK_ERROR_CODE = EDK_OK if the command succeeded
	 */
	int IEE_EdfGetTotalTime(int totalTime);
	 ...
	 *                    - EDK_ERROR_CODE - EDK_ERROR_CODE = EDK_OK if the command succeeded
	 */
	void IEE_EdfStartSaving(int userID, String filename, String patientID,
	 ...
	 *                 - EDK_ERROR_CODE - EDK_ERROR_CODE = EDK_OK if the command succeeded
	 */
	void IEE_EdfStopSaving(int userID);
