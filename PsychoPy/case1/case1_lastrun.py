...
expName = 'case1'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/akulka16/Downloads/Psychopy/case1/case1.psyexp',
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *movie_2* updates
        if t >= 6 and movie_2.status == NOT_STARTED:
            # keep track of start time/frame for later
            movie_2.tStart = t
            movie_2.frameNStart = frameN  # exact frame index
            movie_2.setAutoDraw(True)
        frameRemains = 6 + 5- win.monitorFramePeriod * 0.75  # most of one frame period left
